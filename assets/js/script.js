...
/* ===========================
   ...
   const artworks = [
    { title: "Uhaw sa Hustisya", category: "Visual Arts", description: "The main subject of the artwork is greed and the power of money represented through a drawing of a wealthy crocodile dressed in a suit. It explores the ongoing issue of corruption in our country, exposing the rotten ways used in “silencing” the voices of the Filipino people. It was originally made as commissioned artwork in which the artist used it as an opportunity for social advocacy and to raise awareness.", artist: "Inoue", medium: "Digital Drawing", category: "visual", year: "2025", image: "assets/visual arts/labrador.webp" },
    
    { title: "Corruption in the Philippines", category: "Visual Arts", description: "Corruption in the Philippines is a drawing that reflects the grim reality of justice and morality in our country. At the center of the piece is a crocodile lavishly throwing around money, with its tail creating a hole through the broken gavel it sits on. This symbolizes the consequence of corruption, breaking the very foundation and instrument of the justice system in which ordinary people rely on.", artist: "Nathaniel Esplana", medium: "Drawing", category: "visual", year: "2025", image: "assets/visual arts/belga.webp" },
