...
/* ===========================
 ...
 const artworks = [
    //use streamable
    { title: "The Battle Against Corruption: Bringing Back the Light", category: "Literary Arts", description: "", artist: "Von Justin Estayani", medium: "Digital Text", category: "literature", year: "2025", image: null, videoEmbed: "https://streamable.com/e/kiviv1" }
];
    ...
    : a.videoEmbed
      ...
      : `<div class="thumb-placeholder"></div>`
        ...
        <div class="card-body">
            ...
            <div class="meta"><button class="insta-btn" id="likeBtn" aria-pressed="false" title="Like">
                                <svg class="icon-heart" viewBox="0 0 48 48" width="30" height="30" fill="none"
                                    stroke="currentColor" stroke-width="3">
                                    <path d="M34.3 6c-4.3 0-7.6 2.1-10.3 5.4C21.3 8.1 18 6 13.7 6 
             7.6 6 3 10.7 3 16.9c0 12 16.7 21.6 21 23.7 
             4.3-2.1 21-11.7 21-23.7C45 10.7 40.4 6 34.3 6z" />
                                </svg>
                            </button><span>${a.medium || ''}</span><span> Â· ${a.year || ''}</span></div>
        </div>
    `;
...
// Show YouTube embed
else if (a.videoEmbed) {
    modalVideoEmbed.style.display = "block";
    modalVideoEmbed.src = a.videoEmbed + "?rel=0&modestbranding=1";
}
    if (short.long) {
